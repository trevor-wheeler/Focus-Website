      ...
      >
        ...
        <div className='tos-btn-container-background'>
          <div className='tos-btn-container tos-page'>
            ...
            >
              <button id='agree-btn' className='tos-btn'><i className=" tos-btn-icon bi bi-shield-fill-check"></i> <span className='tos-btn-text'>Agree and continue</span></button>
            </motion.div>
          </div>
            ...
            <div className='toggle-container'>
              ...
              <div className="form-check form-switch">
                <div id='toggle-btn' onClick={toggle}>
                  <input className="form-check-input" data-option="focus-mellowtel" type="checkbox" role="switch" checked readOnly></input>
                </div>
              </div>
            </div>
          </div>
